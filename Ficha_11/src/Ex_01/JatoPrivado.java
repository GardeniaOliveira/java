...
public class JatoPrivado extends Aviao{
        ...
        public JatoPrivado(int n_serie, int n_motores, String modelo, Date ano_fabrico, double peso, double comprimento_fuselagem, double envergadura_asas, double altura_cauda, double autonomia, double velocidade, double preco, int lotacao, double capacidade_bagagem, CategoriaJato categoria, ArrayList<Instalacoes> inst) {
